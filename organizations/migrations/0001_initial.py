# Generated by Django 5.2.7 on 2025-10-10 09:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('MANAGER', 'Manager'), ('RECRUITER', 'Recruiter'), ('VIEWER', 'Viewer')], default='viewer', max_length=20)),
