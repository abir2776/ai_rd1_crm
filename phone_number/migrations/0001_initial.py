    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "friendly_name",
                    models.CharField(
                        help_text="Friendly name for the end user", max_length=255
                    ),
                ),
                (
                    "end_user_type",
                ...
                (
                    "email",
                    models.EmailField(
                        help_text="Email of authorized representative", max_length=254
                    ),
                ),
                (
                    "phone_number",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "friendly_name",
                    models.CharField(
                        help_text="Friendly name for the bundle", max_length=255
                    ),
                ),
                (
                    "status",
                ...
                (
                    "end_user_type",
                    models.CharField(
                        help_text="End user type: individual or business", max_length=20
                    ),
                ),
                (
                    "regulation_sid",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="phone_number.regulatorybundle",
                    ),
                ),
                (
                    "organization",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "friendly_name",
                    models.CharField(
                        help_text="Friendly name for the subaccount", max_length=255
                    ),
                ),
                (
                    "status",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="bundles",
                to="phone_number.twiliosubaccount",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "friendly_name",
                    models.CharField(
                        help_text="Friendly name for the address", max_length=255
                    ),
                ),
                (
                    "customer_name",
                    models.CharField(
                        help_text="Name of the customer/business", max_length=255
                    ),
                ),
                (
                    "street",
                ...
                (
                    "region",
                    models.CharField(help_text="State/Province/Region", max_length=100),
                ),
                (
                    "postal_code",
                ...
                (
                    "iso_country",
                    models.CharField(
                        help_text="2-digit ISO country code", max_length=2
                    ),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number_type",
                    models.CharField(
                        help_text="local, mobile, national, toll-free", max_length=20
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="phone_number.regulatoryaddress",
                    ),
                ),
                (
                    "bundle",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="twilio_phon_organiz_b13383_idx",
                    ),
                    models.Index(
                        fields=["subaccount_id", "status"],
                        name="twilio_phon_subacco_63aa37_idx",
                    ),
                    models.Index(
                        fields=["phone_number"], name="twilio_phon_phone_n_d9d7b3_idx"
                    ),
                    models.Index(
                        fields=["twilio_sid"], name="twilio_phon_twilio__e521f8_idx"
                    ),
                ],
            },
            bases=(dirtyfields.dirtyfields.DirtyFieldsMixin, models.Model),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["organization_id", "status"],
                name="regulatory__organiz_1d3dfa_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="regulatorybundle",
            index=models.Index(
                fields=["bundle_sid"], name="regulatory__bundle__5eceb7_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["organization_id", "status"],
                name="regulatory__organiz_80b52a_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="regulatoryaddress",
            index=models.Index(
                fields=["address_sid"], name="regulatory__address_3b6161_idx"
            ),
        ),
    ]
