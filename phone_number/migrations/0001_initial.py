    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('PENDING_REVIEW', 'Pending Review'), ('IN_REVIEW', 'In Review'), ('TWILIO_APPROVED', 'Twilio Approved'), ('TWILIO_REJECTED', 'Twilio Rejected'), ('PROVISIONALLY_APPROVED', 'Provisionally Approved')], default='DRAFT', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(help_text='Uploaded document file', upload_to='regulatory_documents/%Y/%m/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending Compliance'), ('IN_REVIEW', 'In Review'), ('ACTIVE', 'Active'), ('SUSPENDED', 'Suspended'), ('RELEASED', 'Released')], default='PENDING', max_length=20)),
